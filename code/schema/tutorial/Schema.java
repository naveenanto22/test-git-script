...
public final class Schema {
  ...
  public interface PersonOrBuilder extends
     ...
     */
    java.util.List<tutorial.Schema.Person.PhoneNumber> 
        getPhonesList();
    /**
     * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
     */
    tutorial.Schema.Person.PhoneNumber getPhones(int index);
    /**
     * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
     */
    int getPhonesCount();
     ...
     * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
     */
    java.util.List<? extends tutorial.Schema.Person.PhoneNumberOrBuilder> 
        getPhonesOrBuilderList();
    /**
     * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
     */
    tutorial.Schema.Person.PhoneNumberOrBuilder getPhonesOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 34: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                phones_ = new java.util.ArrayList<tutorial.Schema.Person.PhoneNumber>();
                mutable_bitField0_ |= 0x00000001;
              }
              phones_.add(
                  input.readMessage(tutorial.Schema.Person.PhoneNumber.parser(), extensionRegistry));
              break;
            }
            case 42: {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return tutorial.Schema.internal_static_tutorial_Person_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return tutorial.Schema.internal_static_tutorial_Person_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              tutorial.Schema.Person.class, tutorial.Schema.Person.Builder.class);
    }
    ...
    public enum PhoneType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return tutorial.Schema.Person.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public interface PhoneNumberOrBuilder extends
       ...
       * @return The type.
       */
      tutorial.Schema.Person.PhoneType getType();

      /**
       * <code>string areacode = 3;</code>
       * @return The areacode.
       */
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return tutorial.Schema.internal_static_tutorial_Person_PhoneNumber_descriptor;
      }

      @java.lang.Override
      protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
          internalGetFieldAccessorTable() {
        return tutorial.Schema.internal_static_tutorial_Person_PhoneNumber_fieldAccessorTable
            .ensureFieldAccessorsInitialized(
                tutorial.Schema.Person.PhoneNumber.class, tutorial.Schema.Person.PhoneNumber.Builder.class);
      }
       ...
       * @return The type.
       */
      public tutorial.Schema.Person.PhoneType getType() {
        @SuppressWarnings("deprecation")
        tutorial.Schema.Person.PhoneType result = tutorial.Schema.Person.PhoneType.valueOf(type_);
        return result == null ? tutorial.Schema.Person.PhoneType.UNRECOGNIZED : result;
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        if (type_ != tutorial.Schema.Person.PhoneType.MOBILE.getNumber()) {
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (!(obj instanceof tutorial.Schema.Person.PhoneNumber)) {
          return super.equals(obj);
        }
        tutorial.Schema.Person.PhoneNumber other = (tutorial.Schema.Person.PhoneNumber) obj;
      ...
      public static tutorial.Schema.Person.PhoneNumber parseFrom(
      ...
      public static tutorial.Schema.Person.PhoneNumber parseFrom(byte[] data)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return PARSER.parseFrom(data);
      }
      public static tutorial.Schema.Person.PhoneNumber parseFrom(
      ...
      public static tutorial.Schema.Person.PhoneNumber parseFrom(java.io.InputStream input)
          throws java.io.IOException {
      ...
      public static tutorial.Schema.Person.PhoneNumber parseDelimitedFrom(java.io.InputStream input)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
            .parseDelimitedWithIOException(PARSER, input);
      }
      public static tutorial.Schema.Person.PhoneNumber parseDelimitedFrom(
          java.io.InputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        return com.google.protobuf.GeneratedMessageV3
      ...
      public static Builder newBuilder(tutorial.Schema.Person.PhoneNumber prototype) {
      ...
      public static final class Builder extends
          ...
          tutorial.Schema.Person.PhoneNumberOrBuilder {
        public static final com.google.protobuf.Descriptors.Descriptor
            getDescriptor() {
          return tutorial.Schema.internal_static_tutorial_Person_PhoneNumber_descriptor;
        }
        ...
        // Construct using tutorial.Schema.Person.PhoneNumber.newBuilder()
        private Builder() {
        ...
        @java.lang.Override
        public tutorial.Schema.Person.PhoneNumber getDefaultInstanceForType() {
          return tutorial.Schema.Person.PhoneNumber.getDefaultInstance();
        }

        @java.lang.Override
        public tutorial.Schema.Person.PhoneNumber build() {
          tutorial.Schema.Person.PhoneNumber result = buildPartial();
        ...
        @java.lang.Override
        public tutorial.Schema.Person.PhoneNumber buildPartial() {
          tutorial.Schema.Person.PhoneNumber result = new tutorial.Schema.Person.PhoneNumber(this);
        ...
        public Builder mergeFrom(com.google.protobuf.Message other) {
          if (other instanceof tutorial.Schema.Person.PhoneNumber) {
            return mergeFrom((tutorial.Schema.Person.PhoneNumber)other);
          } else {
        ...
        public Builder mergeFrom(tutorial.Schema.Person.PhoneNumber other) {
          if (other == tutorial.Schema.Person.PhoneNumber.getDefaultInstance()) return this;
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          tutorial.Schema.Person.PhoneNumber parsedMessage = null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
            parsedMessage = (tutorial.Schema.Person.PhoneNumber) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
         ...
         * @return This builder for chaining.
         */
        public Builder setType(tutorial.Schema.Person.PhoneType value) {
          if (value == null) {
            throw new NullPointerException();
          }
  ...
  checkByteStringIsUtf8(value);
      ...
      private static final tutorial.Schema.Person.PhoneNumber DEFAULT_INSTANCE;
      static {
        DEFAULT_INSTANCE = new tutorial.Schema.Person.PhoneNumber();
      }

      public static tutorial.Schema.Person.PhoneNumber getDefaultInstance() {
    ...
    private java.util.List<tutorial.Schema.Person.PhoneNumber> phones_;
    /**
     * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
     */
    public java.util.List<tutorial.Schema.Person.PhoneNumber> getPhonesList() {
      return phones_;
    }
    /**
     * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
     */
    public java.util.List<? extends tutorial.Schema.Person.PhoneNumberOrBuilder> 
        getPhonesOrBuilderList() {
      return phones_;
    }
    /**
     ...
     * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
     */
    public tutorial.Schema.Person.PhoneNumber getPhones(int index) {
      return phones_.get(index);
    }
    /**
     * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
     */
    public tutorial.Schema.Person.PhoneNumberOrBuilder getPhonesOrBuilder(
        int index) {
      return phones_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof tutorial.Schema.Person)) {
        return super.equals(obj);
      }
      tutorial.Schema.Person other = (tutorial.Schema.Person) obj;
    ...
    public static tutorial.Schema.Person parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static tutorial.Schema.Person parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static tutorial.Schema.Person parseFrom(
    ...
    public static tutorial.Schema.Person parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static tutorial.Schema.Person parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static tutorial.Schema.Person parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(tutorial.Schema.Person prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        tutorial.Schema.PersonOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return tutorial.Schema.internal_static_tutorial_Person_descriptor;
      }
      ...
      // Construct using tutorial.Schema.Person.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public tutorial.Schema.Person getDefaultInstanceForType() {
        return tutorial.Schema.Person.getDefaultInstance();
      }

      @java.lang.Override
      public tutorial.Schema.Person build() {
        tutorial.Schema.Person result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public tutorial.Schema.Person buildPartial() {
        tutorial.Schema.Person result = new tutorial.Schema.Person(this);
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof tutorial.Schema.Person) {
          return mergeFrom((tutorial.Schema.Person)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(tutorial.Schema.Person other) {
        if (other == tutorial.Schema.Person.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        tutorial.Schema.Person parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (tutorial.Schema.Person) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensurePhonesIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          phones_ = new java.util.ArrayList<tutorial.Schema.Person.PhoneNumber>(phones_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          tutorial.Schema.Person.PhoneNumber, tutorial.Schema.Person.PhoneNumber.Builder, tutorial.Schema.Person.PhoneNumberOrBuilder> phonesBuilder_;
      ...
      public Builder setPhones(
          int index, tutorial.Schema.Person.PhoneNumber value) {
        if (phonesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setPhones(
          int index, tutorial.Schema.Person.PhoneNumber.Builder builderForValue) {
        if (phonesBuilder_ == null) {
          ensurePhonesIsMutable();
       ...
       * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
       */
      public Builder addPhones(tutorial.Schema.Person.PhoneNumber value) {
        if (phonesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addPhones(
          tutorial.Schema.Person.PhoneNumber.Builder builderForValue) {
        if (phonesBuilder_ == null) {
          ensurePhonesIsMutable();
      ...
      public Builder addAllPhones(
          java.lang.Iterable<? extends tutorial.Schema.Person.PhoneNumber> values) {
        if (phonesBuilder_ == null) {
          ensurePhonesIsMutable();
       ...
       * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
       */
      public tutorial.Schema.Person.PhoneNumber.Builder getPhonesBuilder(
          int index) {
       ...
       * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
       */
      public tutorial.Schema.Person.PhoneNumber.Builder addPhonesBuilder() {
        return getPhonesFieldBuilder().addBuilder(
            tutorial.Schema.Person.PhoneNumber.getDefaultInstance());
      }
      /**
       * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
       */
      public tutorial.Schema.Person.PhoneNumber.Builder addPhonesBuilder(
          int index) {
        return getPhonesFieldBuilder().addBuilder(
            index, tutorial.Schema.Person.PhoneNumber.getDefaultInstance());
      }
      /**
       * <code>repeated .tutorial.Person.PhoneNumber phones = 4;</code>
       */
      public java.util.List<tutorial.Schema.Person.PhoneNumber.Builder> 
           getPhonesBuilderList() {
        return getPhonesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          tutorial.Schema.Person.PhoneNumber, tutorial.Schema.Person.PhoneNumber.Builder, tutorial.Schema.Person.PhoneNumberOrBuilder> 
          getPhonesFieldBuilder() {
        if (phonesBuilder_ == null) {
    ...
    private static final tutorial.Schema.Person DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new tutorial.Schema.Person();
    }

    public static tutorial.Schema.Person getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  public interface AddressBookOrBuilder extends
     ...
     */
    java.util.List<tutorial.Schema.Person> 
        getPeopleList();
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    tutorial.Schema.Person getPeople(int index);
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    int getPeopleCount();
     ...
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    java.util.List<? extends tutorial.Schema.PersonOrBuilder> 
        getPeopleOrBuilderList();
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    tutorial.Schema.PersonOrBuilder getPeopleOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                people_ = new java.util.ArrayList<tutorial.Schema.Person>();
                mutable_bitField0_ |= 0x00000001;
              }
              people_.add(
                  input.readMessage(tutorial.Schema.Person.parser(), extensionRegistry));
              break;
            }
            default: {
              if (!parseUnknownField(
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return tutorial.Schema.internal_static_tutorial_AddressBook_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return tutorial.Schema.internal_static_tutorial_AddressBook_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              tutorial.Schema.AddressBook.class, tutorial.Schema.AddressBook.Builder.class);
    }

    public static final int PEOPLE_FIELD_NUMBER = 1;
    private java.util.List<tutorial.Schema.Person> people_;
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public java.util.List<tutorial.Schema.Person> getPeopleList() {
      return people_;
    }
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public java.util.List<? extends tutorial.Schema.PersonOrBuilder> 
        getPeopleOrBuilderList() {
      return people_;
    }
    /**
     ...
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public tutorial.Schema.Person getPeople(int index) {
      return people_.get(index);
    }
    /**
     * <code>repeated .tutorial.Person people = 1;</code>
     */
    public tutorial.Schema.PersonOrBuilder getPeopleOrBuilder(
        int index) {
      return people_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof tutorial.Schema.AddressBook)) {
        return super.equals(obj);
      }
      tutorial.Schema.AddressBook other = (tutorial.Schema.AddressBook) obj;
    ...
    public static tutorial.Schema.AddressBook parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static tutorial.Schema.AddressBook parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static tutorial.Schema.AddressBook parseFrom(
    ...
    public static tutorial.Schema.AddressBook parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static tutorial.Schema.AddressBook parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static tutorial.Schema.AddressBook parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(tutorial.Schema.AddressBook prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    @java.lang.Override
    public Builder toBuilder() {
    ...
    public static final class Builder extends
        ...
        tutorial.Schema.AddressBookOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return tutorial.Schema.internal_static_tutorial_AddressBook_descriptor;
      }
      ...
      // Construct using tutorial.Schema.AddressBook.newBuilder()
      private Builder() {
        maybeForceBuilderInitialization();
      }
      ...
      @java.lang.Override
      public tutorial.Schema.AddressBook getDefaultInstanceForType() {
        return tutorial.Schema.AddressBook.getDefaultInstance();
      }

      @java.lang.Override
      public tutorial.Schema.AddressBook build() {
        tutorial.Schema.AddressBook result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      @java.lang.Override
      public tutorial.Schema.AddressBook buildPartial() {
        tutorial.Schema.AddressBook result = new tutorial.Schema.AddressBook(this);
        int from_bitField0_ = bitField0_;
        if (peopleBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
            people_ = java.util.Collections.unmodifiableList(people_);
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof tutorial.Schema.AddressBook) {
          return mergeFrom((tutorial.Schema.AddressBook)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(tutorial.Schema.AddressBook other) {
        if (other == tutorial.Schema.AddressBook.getDefaultInstance()) return this;
        if (peopleBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        tutorial.Schema.AddressBook parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (tutorial.Schema.AddressBook) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      private void ensurePeopleIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          people_ = new java.util.ArrayList<tutorial.Schema.Person>(people_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          tutorial.Schema.Person, tutorial.Schema.Person.Builder, tutorial.Schema.PersonOrBuilder> peopleBuilder_;
      ...
      public Builder setPeople(
          int index, tutorial.Schema.Person value) {
        if (peopleBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setPeople(
          int index, tutorial.Schema.Person.Builder builderForValue) {
        if (peopleBuilder_ == null) {
          ensurePeopleIsMutable();
       ...
       * <code>repeated .tutorial.Person people = 1;</code>
       */
      public Builder addPeople(tutorial.Schema.Person value) {
        if (peopleBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addPeople(
          tutorial.Schema.Person.Builder builderForValue) {
        if (peopleBuilder_ == null) {
          ensurePeopleIsMutable();
      ...
      public Builder addAllPeople(
          java.lang.Iterable<? extends tutorial.Schema.Person> values) {
        if (peopleBuilder_ == null) {
          ensurePeopleIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, people_);
       ...
       * <code>repeated .tutorial.Person people = 1;</code>
       */
      public tutorial.Schema.Person.Builder getPeopleBuilder(
          int index) {
       ...
       * <code>repeated .tutorial.Person people = 1;</code>
       */
      public tutorial.Schema.Person.Builder addPeopleBuilder() {
        return getPeopleFieldBuilder().addBuilder(
            tutorial.Schema.Person.getDefaultInstance());
      }
      /**
       * <code>repeated .tutorial.Person people = 1;</code>
       */
      public tutorial.Schema.Person.Builder addPeopleBuilder(
          int index) {
        return getPeopleFieldBuilder().addBuilder(
            index, tutorial.Schema.Person.getDefaultInstance());
      }
      /**
       * <code>repeated .tutorial.Person people = 1;</code>
       */
      public java.util.List<tutorial.Schema.Person.Builder> 
           getPeopleBuilderList() {
        return getPeopleFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          tutorial.Schema.Person, tutorial.Schema.Person.Builder, tutorial.Schema.PersonOrBuilder> 
          getPeopleFieldBuilder() {
        if (peopleBuilder_ == null) {
    ...
    private static final tutorial.Schema.AddressBook DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new tutorial.Schema.AddressBook();
    }

    public static tutorial.Schema.AddressBook getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\014schema.proto\022\010tutorial\032\037google/protobu" +
      "f/timestamp.proto\"\231\002\n\006Person\022\014\n\004name\030\001 \001" +
      "(\t\022\n\n\002id\030\002 \001(\005\022\r\n\005email\030\003 \001(\t\022,\n\006phones\030" +
      "\004 \003(\0132\034.tutorial.Person.PhoneNumber\0220\n\014l" +
      "ast_updated\030\005 \001(\0132\032.google.protobuf.Time" +
      "stamp\032Y\n\013PhoneNumber\022\016\n\006number\030\001 \001(\t\022(\n\004" +
      "type\030\002 \001(\0162\032.tutorial.Person.PhoneType\022\020" +
      "\n\010areacode\030\003 \001(\t\"+\n\tPhoneType\022\n\n\006MOBILE\020" +
      "\000\022\010\n\004HOME\020\001\022\010\n\004WORK\020\002\"/\n\013AddressBook\022 \n\006" +
      "people\030\001 \003(\0132\020.tutorial.PersonB\'\252\002$Googl" +
    ...
    internal_static_tutorial_Person_PhoneNumber_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_tutorial_Person_PhoneNumber_descriptor,
        new java.lang.String[] { "Number", "Type", "Areacode", });
    internal_static_tutorial_AddressBook_descriptor =
